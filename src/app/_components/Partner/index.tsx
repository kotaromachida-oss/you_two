...
export default function PartnerContent({ value, onChange, onResult }: PartnerContentProps) {
     ...
     <Card>
      <div className={styles.inner}>
        ...
        <div className={styles.buttonWrapper}>
          <Button variant="primary" onClick={handleNext}>結果を見る</Button>
        </div>
      </div>
    </Card>
  )
